...
งาน: แยกเฉพาะ "ข้อเท็จจริงเกี่ยวกับผู้ป่วย" (Patient Specific Facts) และ "คำแนะนำเฉพาะเจาะจง" (Specific Recommendations) ที่ปรากฏในข้อความ
**สิ่งที่ต้องละเว้น (ห้ามแยกออกมาเป็น Claims เด็ดขาด):**
1. ประโยคสรุปความเสี่ยงมาตรฐาน:
   - "จากผลประเมินพบว่ามีความเสี่ยง..." (สูง/กลาง/ต่ำ)
   - "อาการโดยรวมอยู่ในเกณฑ์ปกติ"
   - "ไม่สามารถสรุปผลความเสี่ยงได้เนื่องจากอาการมีความซับซ้อน"
2. ประโยค Action มาตรฐาน:
   - "หากมีข้อสงสัย โทร..."
   - "ทีมพยาบาลจะติดต่อกลับ..."
   - "แนะนำให้โทรติดต่อพยาบาลทันที..."
3. คำเชื่อม: "เนื่องจาก", "คำแนะนำเพิ่มเติมตามอาการ", "ดูแลตามคำแนะนำจากแพทย์"

ตัวอย่าง 1 (Low Risk):
ข้อความ: "จากผลประเมินพบว่ามีความเสี่ยงต่ำ อาการโดยรวมอยู่ในเกณฑ์ปกติ ผู้ป่วยมีอาการปวด 8/10 และมีเลือดออก หากมีข้อสงสัย โทร 02-xxx-xxxx"
Claims (เอาเฉพาะข้อเท็จจริง):
- ผู้ป่วยมีอาการปวด 8/10
- ผู้ป่วยมีเลือดออก

ตัวอย่าง 2 (High Risk - สำคัญมาก):
ข้อความ: "จากการประเมิน พบว่าคุณสมชาย มีความเสี่ยงต่อการเกิดภาวะแทรกซ้อนหลังการผ่าตัดในช่องปากในระดับสูง เนื่องจาก มีเลือดออกมากผิดปกติและปวดบวมรุนแรง แนะนำ: • เลือดออก: กัดผ้าก๊อซแน่นๆ • อาการบวม: ประคบเย็นทันที แนะนำให้ติดต่อพยาบาลโดยเร็ว โทร 02-xxx-xxxx เพื่อรับการประเมินอาการหรือนัดหมายเป็นกรณีพิเศษ"
Claims (แยกเฉพาะสาเหตุและคำแนะนำ):
- มีเลือดออกมากผิดปกติ
- มีอาการปวดบวมรุนแรง
- แนะนำให้กัดผ้าก๊อซแน่นๆ
- แนะนำให้ประคบเย็นทันที
(สังเกตว่าตัดประโยคความเสี่ยงสูง, ประโยคติดต่อพยาบาล, และหัวข้อ Recommend ออก)
...
- เป็นข้อมูลที่สามารถอนุมานได้จากข้อมูลอ้างอิงหรือมีความหมายใกล้เคียงกัน
- **เป็นข้อความมาตรฐานตาม Format ที่ระบุไว้**

ตอบ 'no' ถ้า:
- คำกล่าวขัดแย้งกับข้อมูล
- แต่งเรื่องหรือข้อมูลที่ไม่มีในอ้างอิงไปมาก
- พูดเกินความจริงไปไกลมาก

ตอบแค่คำเดียว: yes/no
(ห้ามอธิบายยาว)
"""
